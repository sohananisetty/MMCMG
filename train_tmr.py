...
from configs.config_tmr import cfg, get_cfg_defaults
from core import MotionRep
from ctl.trainer_tmr import TMRTrainer
...
if __name__ == "__main__":
    ...
    cfg.motion_encoder.nfeats = mot_dim
    cfg.motion_decoder.nfeats = mot_dim
